<template>
  <div class="banner-root">
    <div class="banner-header bodyMedium12px" :class="{ visible: isListingHeader }">
      <img src="@/assets/icons/star_pin.png" alt="추천 아이콘" class="banner-icon" />
      <span class="highlight titleBold12px">{{ userName }}</span>님이 찾으시는
      <span class="highlight titleBold12px">&nbsp;조건과 유사한 매물</span>을 추천드려요!
    </div>

    <div class="slider" ref="sliderRef" @mouseenter="pause()" @mouseleave="play()">
      <div
        class="track"
        :style="{
