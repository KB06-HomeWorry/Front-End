<template>
  <div class="home-root">
    <div class="home-btn-row">
      <HomeBtn80px text="아파트" icon="/src/assets/icons/home_apartment.png" @click="() => go('/map/apart')" />
      <HomeBtn80px text="원.투룸" icon="/src/assets/icons/home_oneroom.png" @click="() => go('/map/onetwo')" />
      <HomeBtn80px text="빌라.주택" icon="/src/assets/icons/home_villa.png" @click="() => go('/map/villa')" />
      <HomeBtn80px text="오피스텔" icon="/src/assets/icons/home_officetel.png" @click="() => go('/map/officetel')" />
    </div>
    ...
    <div class="home-btn-row">
      <HomeBtnSmall text="전문 용어<br/>해석 챗봇" icon="/src/assets/icons/home_chatbot.png" @click="() => go('/chatbot')" />
      <HomeBtnSmall text="부동산<br/>용어 퀴즈" icon="/src/assets/icons/home_quiz.png" @click="() => go('/quiz')" />
      <HomeBtnSmall text="중개수수료<br/>계산기" icon="/src/assets/icons/home_calculator.png" @click="() => go('/calculator')" />
    </div>
  </div>
</template>
