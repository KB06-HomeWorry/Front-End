...
const props = defineProps({
  ...
  correctImg: { type: String, default: '/src/assets/icons/quiz_correct_text.png' }, 
  wrongImg: { type: String, default: '/src/assets/icons/quiz_wrong_text.png' }, 
  hintIcon: { type: String, default: '/src/assets/icons/quiz_lightbulb.png' }
})
